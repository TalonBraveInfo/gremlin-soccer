...
long int UnMangleMemToMem(unsigned char *source, unsigned char *dest)
{
int c;
int u,v;
unsigned char *pt;
...
long int UnMangleFileToMem(char *srcfile,unsigned char *dest)
	{
...
#ifdef Joolz
long int UnMangleFileToFile(char *srcfile,char *destfile)
	{
