...
// old actua	 		InitialiseMOUSE();
    ...
    //��������������������������������������������������������������ͻ
    //�                                                              �
    //� MATCH SETUP MODULE-> PASSING FRONTEND DATA TO ANDY's SECTION �
    //�                                                              �
    //��������������������������������������������������������������ͼ
    ...
    for (char c = 0; c < 4; c++) { EUROmatch_info.CntrlTypes[c] = -1; }
    ...
    //���������������������������������������������ͻ
    //�                                             �
    //� COPY BOTH TEAMS PLAYER DATA INTO MATCH INFO �
    //�                                             �
    //���������������������������������������������ͼ
    ...
    //�������������������������������������������������������ͻ
    //�                                                       �
    //� VERBOSE INFORMATION, DISPLAYS MATCH DATA IF REQUESTED �
    //�                                                       �
    //�������������������������������������������������������ͼ
...
//			setup.team_b			=	1;
    ...
    if (MatchNumber > 23) {
        ...
        } else if (EUROmatch_info.extra != 0 && EUROmatch_info.penalties == 0) {
...
//				printf("     B dpts %d\n", performance[p+20].dpts );
    ...
    //�������������������������������������������������������������������ͻ
    //�                                                                   �
    //� RESET FRONTEND VARIABLES WHICH MAY HAVE BEEN ALTERED DURING MATCH �
    //�                                                                   �
    //�������������������������������������������������������������������ͼ
    ...
    if (EUROgameType == EURO_championship) {
        ...
        if (MatchNumber < 24) {
            ...
            } else if (EUROmatch_info.Team_A_goals < EUROmatch_info.Team_B_goals) {
