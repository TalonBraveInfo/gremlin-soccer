...
//		     HaveNETteamsBeenChosen() == Yes )
    ...
    if (MENU == TEAM_SELECT && LogicState == RUN_FRONTEND && //ChangeMenu == -1
    ...
    else if (MENU == TEAM_SELECT && LogicState == RUN_FRONTEND) {
        ...
        //�����������������������������������������ͻ
        //�                                         �
        //� Ready to start Championship competition �
        //�                                         �
        //�����������������������������������������ͼ
...

        {
            ...
            //�����������������������������������������������������ͻ
            //�                                                     �
            //� User Selects team for Euro Championship competition �
            //�                                                     �
            //�����������������������������������������������������ͼ
            ...
            //����������������������������������ͻ
            //�                                  �
            //� User wishes to add an extra user �
            //�                                  �
            //����������������������������������ͼ
            ...
            //��������������������������������������������������ͻ
            //�                                                  �
            //� User wishes to change to squad selection options �
            //�                                                  �
            //��������������������������������������������������ͼ
