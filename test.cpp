...
//�                                                                                                                              �
//�                                                                                                                              �
//�		Christine's new work number:	2784293                                                                          �
//�             My new mobile number:		0973 868837                                                                      �
//�             Caroline:			0589 665323                                                                      �
//�                                             2446227                                                                          �
//�             Andy Finlay:			2390248                                                                          �
//�             Justin Longden's mobile number: 0973 169931                                                                      �
//� 		Philip Durbidge work number:	2734391                                                                          �
//�             Jason Wragg's Home number:	2352544                                                                          �
//�                                                                                                                              �
//�                                                                                                                              �
//�                                                                                                                              �
//�  Changes to formation types:                                                                                                 �
//�                                                                                                                              �
//�  	England		4-4-2     done                                                                                           �
//�     Bulgaria	1-3-3-3                                                                                                  �
//�     Croatia		5-3-2     done                                                                                           �
//�     Czech Rep.	5-3-2     done                                                                                           �
//�     Denmark		5-4-1                                                                                                    �
//�     France		4-4-2     done                                                                                           �
//�     Germany		5-3-2     done                                                                                           �
//�     Holland		3-4-3                                                                                                    �
...
int menu_update = 0;
char rerun_menu = 0;
int MarkSquadPlayer = 0;
int MarkSlotNumber = 0;
int MarkControlType = 0;
int current_spool = 0;
...
int criticalhandler(unsigned deverror, unsigned errcode, unsigned *devhdr);
...
//������������������������������������������������������������������������������������������������������������������������������ͼ 
    ...
    ReadDataOffsetFile(EuroOFFSETfile);        // Load data offset file.
...
//������������������������������������������������������������������������������������������������������������������������������ͻ 
//�                                                                                                                              �
//�  Checks command line for verbose options.                                                                                    �
//�												                                 �
//������������������������������������������������������������������������������������������������������������������������������ͼ 
    ...
    match_info.menu_res = HI;
    force_res = NULL;
    match_info.language = (char) Language;
    no_cd = FALSE;
...
//������������������������������������������������������������������������������������������������������������������������������ͻ 
//�                                                                                                                              �
//�  Checks for PC memory and machine speed then sets up game and intro variables.                                               �
//�												                                 �
//������������������������������������������������������������������������������������������������������������������������������ͼ 
...
//������������������������������������������������������������������������������������������������������������������������������ͻ 
//�                                                                                                                              �
//�  Load DATA.DAT file offset table.                                                                                            �
//�												                                 �
//������������������������������������������������������������������������������������������������������������������������������ͼ 
//
...
//������������������������������������������������������������������������������������������������������������������������������ͼ 
                    ...
                    if (EuroTextEditState == 0) {
                        StorePSEUDObuffer(&FrontendPseudoDEFN, &FrontendTextureDEFN, MOUSE_STOREbuff, SelectorXcoord,
                                          SelectorYcoord);
                        DrawIMAGE(&FrontendPseudoDEFN, &FrontendTextureDEFN, MOUSEimages + NoButton,
                                  SelectorXcoord, SelectorYcoord, NO_BOX, spritecopy);
                        AddToDumpList(SelectorXcoord, SelectorYcoord, Image_Widths[MOUSEimages + NoButton],
                                      Image_Heights[MOUSEimages + NoButton]);
                    }
...
int CheckCD(int CD) {
    ...
    filename[0] = (char) (CD + 'A');                        //check the last one we new about
    file ^= 1;
