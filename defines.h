...
struct choose_info {
    struct choose_offsets offsets[3];
    struct choose_setup choose[44];
};
...
typedef struct {
    ...
    char control_methods[NO_OF_CONTROL_METHODS];
    char tga_enable;
...
typedef struct {
    struct fixture_info1 fixture_data;
} fixture_table;
...
typedef struct {
    struct result_info result_data;
} result_table;
