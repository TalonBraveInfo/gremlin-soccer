...
void DisplayFormation(char AddToList) {
    ...
    char *temp = GetTEXT((short) (FormationInfo[Team] + FORM_LIST));
...
//
    ...
    for (signed int s = 9; s > -1; s--) {
        ...
        y = (TeamTactics[(32 * 2) + 5][s][0] / yscale);    // get actual formation y pos.
        ...
        bscale = (int) ((ysize - y) / ((PITCH_YPOS_BL - PITCH_YPOS_TL) / 6));
        ball += (bscale * 20);
...
int FormationLabels[] = {
        ...
        FRPS_LBLE + Gk, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Md, FRPS_LBLE + Fw, FRPS_LBLE + Fw,
        FRPS_LBLE + Fw, FRPS_LBLE + Fw, FRPS_LBLE + Fw,
        FRPS_LBLE + Fw, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
        FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,

        // 4-0-6

        FRPS_LBLE + Gk, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Fw, FRPS_LBLE + Fw,
        FRPS_LBLE + Fw, FRPS_LBLE + Fw, FRPS_LBLE + Fw,
        FRPS_LBLE + Fw, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
        FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
        ...
        FRPS_LBLE + Gk, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Md, FRPS_LBLE + Fw,
        FRPS_LBLE + Fw, FRPS_LBLE + Fw, FRPS_LBLE + Fw,
        FRPS_LBLE + Fw, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
        FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
        ...
        FRPS_LBLE + Gk, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Md, FRPS_LBLE + Md,
        FRPS_LBLE + Fw, FRPS_LBLE + Fw, FRPS_LBLE + Fw,
        FRPS_LBLE + Fw, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
        FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
        ...
        FRPS_LBLE + Gk, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Md, FRPS_LBLE + Md,
        FRPS_LBLE + Md, FRPS_LBLE + Fw, FRPS_LBLE + Fw,
        FRPS_LBLE + Fw, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
        FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
        ...
        FRPS_LBLE + Gk, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Md, FRPS_LBLE + Md,
        FRPS_LBLE + Md, FRPS_LBLE + Md, FRPS_LBLE + Fw,
        FRPS_LBLE + Fw, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
        FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,

        // 5-1-4

        FRPS_LBLE + Gk, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Md,
        FRPS_LBLE + Fw, FRPS_LBLE + Fw, FRPS_LBLE + Fw,
        FRPS_LBLE + Fw, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
        FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
        ...
        FRPS_LBLE + Gk, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df, FRPS_LBLE + Df,
        FRPS_LBLE + Md, FRPS_LBLE + Md, FRPS_LBLE + Md,
        FRPS_LBLE + Fw, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
        FRPS_LBLE + Sb, FRPS_LBLE + Sb, FRPS_LBLE + Sb,
...
void DisplaySquad() {
    ...
    for (char s = 0; s < 20; s++) {
        ...
        DisplayString(
                (500 + 21) - (PixelLengthOfString(GetTEXT(SQUD_NMBS + SquadInfo[(Team * 20) + s]), SMALL_FONT)) / 2,
...
void DoSquadSelection(char MENU, signed char BOX, short xposn, short yposn) {
    if ((MENU == SQUAD_SELECT || MENU == PLAYER_STATS) && LogicState == RUN_FRONTEND) {
        ...
        if ((MarkPlayer == -1) && (BOX != NO_BOX) && (BOX < 20) && (ButtonState == LEFT_BUTTON)) {
            ...
            DeBounce = TRUE;
        } else if (MarkPlayer != -1 && ButtonState == RIGHT_BUTTON && BOX < 20) {
            RedrawSquadPanel();
            MarkPlayer = -1;
            SquadBuffer1yposn = -1;
            ButtonState = 0;
