...
#else
const char *EuroDATfile = "EURO.DAT";
const char *EuroOFFSETfile = "EURO.OFF";
const char *EuroSCRIPTfile = "SCRIPT.96";
#endif
...
const char *EuroGDVfile = "..\\makegdv\\wembley.gdv";
...
void Euro96initialise() {
    ...
    for (char t = 0; t < 16; t++)                        // Reset Group/League table data.
    {
