...
typedef struct tagmemsam {
    const char *name;           // Name of the samples disk file
...
extern int StartMusic(const char *name, int volume);
...
void CreateMusicFileName(const char *name, const char *dest);

void CreateScoreFileName(const char *home, const char *away, const char *mad, const char *dest);

void CreatePitchFileName(const char *name, const char *mad, const char *dest);

void CreatePlayerFileName(const char *country, const char *number, const char *intonation, const char *mad,
                          const char *dest);

void CreateCommentaryFileName(const char *category, const char *number, const char *mad, const char *dest);

void CreateFrontEndFileName(const char *category, const char *name, const char *mad, const char *dest);

int LoadSample(const char *mad, const char *name, memsam *bank, struct memstatus *MemStatus);

void FreeSample(memsam *bank);

void LoadCommentarySample(const char *category, int samples, memsam *bank);

int MADFindFile(FILE *fp, const char *name);

int CheckRepeatBuffer(const char *category, int num);

void ShowMemoryUsage(memstatus MemStatus, const char *title);
